...
public class dialogCrearPersona extends JDialog {
    ...
    public static void main(String[] args) {
        try {
            dialogCrearPersona dialog = new dialogCrearPersona();
    ...
    public dialogCrearPersona() {
        this(null);
    }

   
    public dialogCrearPersona(JFrame parent) {
        super(parent, "Crear Persona", true);
